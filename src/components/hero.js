...
export default function Hero() {
    return (
        ...
        <div className="container">
            <div className=" container relative bg-purple-50 text-gray-900">
                        ...
                        <div className="mx-auto grid max-w-lg grid-cols-1 gap-y-12 lg:max-w-full lg:grid-cols-2 lg:items-center lg:gap-x-8">
                            <div>
                                <div className="text-center lg:text-left">
                                    ...
                                    Your Health, Just a   <br className="block sm:hidden" />
                                    Click Away. <br className="hidden sm:block" />
                                        with{" "}
                            ...
                            <div className="relative bg-violet-100 lg:bg-transparent">
                                ...
                                <div  className="h-[450px] lg:h-[300px] relative"  >
                                    <Image
                                    fill={true}
                                    src={"https://images.unsplash.com/photo-1502740479091-635887520276?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fG1lZGljYWx8ZW58MHx8MHx8fDA%3D"}
                                     />
                                {/* <iframe
