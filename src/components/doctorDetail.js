...
<h1 className="text-lg font-semibold">Hospital : </h1>
<h1 className="text-lg font-semibold">{doctor.hospital}</h1>


                           </div>
                           <div className="flex gap-5 mb-4">
<h1 className="text-lg font-semibold">Timing : </h1>
<h1 className="text-lg font-semibold">{doctor.timing}</h1>


                           </div>
                           <div className="flex gap-5 mb-4">
<h1 className="text-lg font-semibold">Gender : </h1>
<h1 className="text-lg font-semibold">{doctor.gender}</h1>
